...
export default function Services({ compact = false, showImages = true }: ServicesProps) {
  const services: Service[] = [
    ...
    },
    {
      ...
      icon: '📍',
      image: '/17.png',
      href: '/services', // Fallback to main services page
    },
    {
      title: 'Meta Ads',
    ...
    },
    {
      ...
      icon: '🎨',
      image: '/7.png',
      href: '/work', // No direct service page, link to portfolio
    },
    {
      ...
      icon: '🖨️',
      image: '/8.png',
      href: '/contact', // No direct service page, link to contact
    },
    {
      ...
      icon: '💻',
      image: '/9.png',
      href: '/services/automation', // Closest related service
    },
    {
