    ...
    <>
      ...
      <section className="relative z-10 px-6 pb-20">
        <div className="mx-auto max-w-5xl space-y-8">
          <div className="rounded-2xl border border-black/[0.08] bg-black/[0.04] p-6 md:p-8">
            <h2 className="text-lg font-semibold text-[#1A1A1A] mb-3">How the free SEO audit tool works</h2>
          ...
          <div className="rounded-2xl border border-black/[0.08] bg-black/[0.04] p-6 md:p-8">
            <h2 className="text-lg font-semibold text-[#1A1A1A] mb-3">What this tool checks</h2>
            <ul className="grid gap-2 sm:grid-cols-2 text-sm text-[#6B7280]">
