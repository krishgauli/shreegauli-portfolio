    ...
    <PageShell>
      ...
      <section className="relative z-10 pb-20 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-xl font-bold text-[#1A1A1A] mb-6">WordPress sites I&apos;ve built</h2>
      ...
      <section className="relative z-10 pb-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-sm text-[#6B7280] mb-8 max-w-2xl">
            Documented outcomes from WordPress development projects.
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { value: "10+", label: "WordPress sites built", detail: "Custom-theme WordPress builds for healthcare, service, and e-commerce businesses." },
              { value: "95+", label: "Lighthouse score", detail: "Core Web Vitals and SEO scores hit at launch — before any post-launch optimisation." },
              { value: "SEO ready", label: "At launch", detail: "Schema markup, sitemap, robots.txt, image optimisation, and canonical tags configured on every build." },
