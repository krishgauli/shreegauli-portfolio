...
export const metadata: Metadata = createPageMetadata({
  title: "Contact Shree Gauli | Digital Marketing Consultant",
  description:
    "Get in touch for digital marketing consulting, SEO, automation, or web development projects. Typical response within one business day.",
  path: "/contact",
  keywords: ["contact digital marketing consultant", "hire SEO consultant dallas", "marketing automation inquiry"],
});
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-black/[0.08] bg-black/[0.04] p-5">
              <h2 className="text-base font-semibold text-[#1A1A1A]">Projects I take on</h2>
            ...
            <div className="rounded-2xl border border-black/[0.08] bg-black/[0.04] p-5">
              <h2 className="text-base font-semibold text-[#1A1A1A]">Response time</h2>
              <p className="mt-2 text-sm leading-7 text-[#6B7280]">
            ...
            <div className="rounded-2xl border border-black/[0.08] bg-black/[0.04] p-5">
              <h2 className="text-base font-semibold text-[#1A1A1A]">What happens next</h2>
              <p className="mt-2 text-sm leading-7 text-[#6B7280]">
