...
export default function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FDFAF5] px-6">
      <div className="max-w-md text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            href="/services"
            className="inline-flex items-center justify-center px-6 py-3 text-sm font-semibold rounded-xl border border-black/[0.12] text-gray-700 hover:text-gray-900 hover:border-white/[0.2] transition-colors"
          >
            Services
          </Link>
          <Link
