...
export async function GET(req: NextRequest) {
  try {
    ...
    if (!clientId) issues.push('GOOGLE_CLIENT_ID (or NEXT_PUBLIC_GOOGLE_CLIENT_ID fallback) environment variable is not set');
    ...
    return NextResponse.json({
      ...
      requiredApis: [
        ...
        { name: 'Google OAuth consent', purpose: 'Authorize webmasters.readonly scope', required: true },
